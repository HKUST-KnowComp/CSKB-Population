...
if not os.path.exists("../../../data/ASER_core_node2id.npy"):
    np.save("../../../data/ASER_core_node2id", node_dict)
...
nx.write_gpickle(G_new, "../../../data/G_aser_{}.pickle".format(args.scenario))
